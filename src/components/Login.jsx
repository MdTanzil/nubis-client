      ...
      <div className="relative  w-1/5 mx-auto flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
        ...
        <div className="px-6   sm:px-0 max-w-sm">
          <button
            ...
            type="button"
            className="text-white   bg-main hover:bg-main focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
          >
            <svg
